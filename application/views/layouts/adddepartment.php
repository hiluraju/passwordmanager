...
<div class="col-sm-4 col-md-4 col-xs-4"></div>
	<div class="col-sm-6 col-md-6 col-xs-6">
			<h1 class="h4 black mb-4 wei">ADD DEPARTMENT</h1>
			<div class="red wei">
            ...
            <div class="green wei">
                ...
                <?php endif; ?>
                  ...
                  <?php echo form_open("department/adddepartment",$attributes)?>
				...
				<div class="row">
					...
					<div class="col-sm-4 col-md-4 col-xs-4"> 
						<?php $data = array("class" => "btn btn-success btn-user btn-block",
                                          "name"  => "save",
                                          "value" => "Save"); ?>
